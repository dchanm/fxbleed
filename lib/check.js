  ...
  Request({
    ...
    onComplete: function(response) {
      if (response.json === null) {
        ...
        //
        // XXX: need to reassign response since we can't set properties in
        // the response returned from Request
        //
        // TODO: not sure if this is working (handling failed requests due to
        // timeouts/lack of connectivity)
        response = {};
        response.json = {
          "code": 2,
